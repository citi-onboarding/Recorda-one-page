...
import { NewsContainer, NewsTitle, NewsTitleImage, CardsContainer } from "./styles";
import { Hearth } from "../../assets";

export const NewsSection: React.ElementType = () => {
    return (
        <NewsContainer>
            <NewsTitle><NewsTitleImage src={Hearth} alt="Emoji de coração" /> Entendendo melhor <NewsTitleImage src={Hearth} alt="Emoji de coração" /></NewsTitle>
            <CardsContainer>

import { News } from "../../components/news_card/NewsCard";
import { NewsContainer, NewsTitle, CardsContainer } from "./styles";
import { HearthImage } from "../../assets";

export const NewsSection: React.ElementType = () => {
    return (
        <NewsContainer>
            <NewsTitle><img src={HearthImage} alt="Emoji de coração" /> Entendendo melhor <img src={HearthImage} alt="Emoji de coração" /></NewsTitle>
            <CardsContainer>
